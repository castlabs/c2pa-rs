...
* Add `c2pa_builder_sign_fragmented` (with `file_io`) for signing single or glob-selected BMFF renditions and returning their embedded manifest. Reject output collisions before signing.
